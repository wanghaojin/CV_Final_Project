...
"""
Split the image into patches and mask them before stitching them together. 
Save the mask (boolean) as an array. json
...
def stitch(patches, patch_size, output_image_path):
    ...
    num_cols = int(math.sqrt(num_patches))  # square
...
def process_images(input_dir, output_dir, mask_array_dir, patch_size=(16, 16), stitch_dir=None):
    ...
    for image_file in image_files:
        ...
        # save mask_array
        img_name_without_ext = os.path.splitext(image_file)[0]  #drop file extension
