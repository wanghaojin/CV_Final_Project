...
def generate_fixed_mask_array(img_size, patch_size, num_unmasked):
    ...
    # remain 64 patches in center (can change)
    for row in range(2, 10):
        for col in range(2, 10):
            mask_array[row][col] = 0

    # randomly choose unmasked pathces
...
def process_images(input_dir, output_dir, mask_array_dir, patch_size=(16, 16), stitch_dir=None):
    ...
    fixed_mask_array = generate_fixed_mask_array((224, 224), patch_size, 57) # randomly choose 57 patches(can change)
